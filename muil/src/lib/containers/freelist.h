 ...
 */
VAPI void freelist_create(u64 total_size, u64* memory_requirement, void* memory, freelist* out_list);
 ...
 */
VAPI void freelist_destroy(freelist* list);
 ...
 */
VAPI b8 freelist_allocate_block(freelist* list, u64 size, u64* out_offset);
 ...
 */
VAPI b8 freelist_free_block(freelist* list, u64 size, u64 offset);
 ...
 */
VAPI b8 freelist_resize(freelist* list, u64* memory_requirement, void* new_memory, u64 new_size, void** out_old_memory);
 ...
 */
VAPI void freelist_clear(freelist* list);
 ...
 */
VAPI u64 freelist_free_space(freelist* list);
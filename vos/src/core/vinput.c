...
void input_process_key(keys key, b8 pressed) {
    ...
    if (state_ptr->allow_key_repeats || changed) {
        ...
        // if (key == KEY_LALT) {
        //     vinfo("Left alt %s.", pressed ? "pressed" : "released");
        // } else if (key == KEY_RALT) {
        //     vinfo("Right alt %s.", pressed ? "pressed" : "released");
        // }
        
        // if (key == KEY_LCONTROL) {
        //     vinfo("Left ctrl %s.", pressed ? "pressed" : "released");
        // } else if (key == KEY_RCONTROL) {
        //     vinfo("Right ctrl %s.", pressed ? "pressed" : "released");
        // }
        
        // if (key == KEY_LSHIFT) {
        //     vinfo("Left shift %s.", pressed ? "pressed" : "released");
        // } else if (key == KEY_RSHIFT) {
        //     vinfo("Right shift %s.", pressed ? "pressed" : "released");
        // }
